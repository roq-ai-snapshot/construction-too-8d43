  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental - Bridging the gap between individual customers and a world of construction tools. Experience seamless rental from multiple outlets."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental - Bridging the gap between individual customers and a world of construction tools. Experience seamless rental from multiple outlets.`}
            </Text>
            <Box
